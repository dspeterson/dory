...
namespace Dory {
  ...
  /* This class is used for rate limiting of messages on a per-topic basis.
     ...
     slowness in message processing that affects many topics, causing Dory to
     ...
     the Kafka cluster from becoming overwhelmed and forcing Dory to discard
