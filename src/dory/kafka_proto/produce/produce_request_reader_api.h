/* <dory/kafka_proto/produce/produce_request_reader_api.h>
    ...
    namespace Produce {
      ...
      class TProduceRequestReaderApi {
        ...
        class TBadProduceRequest : public std::runtime_error {
          public:
          ~TBadProduceRequest() override = default;
        ...
        virtual ~TProduceRequestReaderApi() = default;

        virtual void Clear() = 0;

        /* Specify a buffer containing a produce request to read. */
