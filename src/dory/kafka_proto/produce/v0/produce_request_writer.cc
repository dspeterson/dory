/* <dory/kafka_proto/produce/v0/produce_request_writer.cc>
   ...
   Implements <dory/kafka_proto/produce/v0/produce_request_writer.h>.
 */
...
void TProduceRequestWriter::OpenRequest(std::vector<uint8_t> &result_buf,
  ...
  Buf->resize(REQUEST_OR_RESPONSE_SIZE_SIZE + PRC::API_KEY_SIZE +
      ...
      PRC::CLIENT_ID_LEN_SIZE + client_id_len + PRC::REQUIRED_ACKS_SIZE +
