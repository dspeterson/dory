/* <dory/kafka_proto/produce/produce_response_reader_api.h>
    ...
    namespace Produce {
      ...
      class TProduceResponseReaderApi {
        ...
        class TBadProduceResponse : public std::runtime_error {
          public:
          ~TBadProduceResponse() noexcept override = default;
        ...
        virtual ~TProduceResponseReaderApi() noexcept = default;

        virtual void Clear() noexcept = 0;

        /* Specify a buffer containing a produce response to read. */
