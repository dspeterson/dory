/* <dory/kafka_proto/v0/metadata_response.test.cc>
   ...
   Unit tests for <dory/kafka_proto/v0/metadata_response_reader.h> and
   <dory/kafka_proto/v0/metadata_response_writer.h>
 */
