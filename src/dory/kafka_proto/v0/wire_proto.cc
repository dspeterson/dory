/* <dory/kafka_proto/v0/wire_proto.cc>
   ...
   Implements <dory/kafka_proto/v0/wire_proto.h>.
 */
...
#include <dory/kafka_proto/v0/metadata_request_writer.h>
#include <dory/kafka_proto/v0/metadata_response_reader.h>
#include <dory/kafka_proto/v0/msg_set_writer.h>
#include <dory/kafka_proto/v0/produce_request_constants.h>
#include <dory/kafka_proto/v0/produce_request_writer.h>
#include <dory/kafka_proto/v0/produce_response_reader.h>
#include <dory/kafka_proto/v0/protocol_util.h>
...
size_t TWireProto::GetResponseSize(const void *response_begin) const {
  assert(this);
  return Dory::KafkaProto::V0::GetRequestOrResponseSize(response_begin);
}
...
bool TWireProto::TopicAutocreateWasSuccessful(const char *topic,
  ...
  /* An error code of 5 means "leader not available", which is what we expect
     ...
     Kafka client (perhaps a Dory instance running on some other host) since
...
TWireProtocol::TConstants TWireProto::ComputeConstants() {
  ...
  constants.BytesNeededToGetResponseSize =
      Dory::KafkaProto::V0::BytesNeededToGetRequestOrResponseSize();
