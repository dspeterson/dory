/* <dory/mock_kafka_server/serialize_cmd.cc>
   ...
   Implements <dory/mock_kafka_server/serialize_cmd.h>.
 */
...
void Dory::MockKafkaServer::SerializeCmd(
...
bool Dory::MockKafkaServer::DeserializeCmd(const std::vector<uint8_t> &buf,
    TCmd &result) {
