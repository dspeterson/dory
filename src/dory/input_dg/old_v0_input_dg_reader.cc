/* <dory/input_dg/old_v0_input_dg_reader.cc>
   ...
   Implements <dory/input_dg/old_v0_input_dg_reader.h>.
 */

#include <dory/input_dg/old_v0_input_dg_reader.h>
...
#include <dory/input_dg/old_v0_input_dg_common.h>
