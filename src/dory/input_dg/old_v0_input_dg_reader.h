/* <dory/input_dg/old_v0_input_dg_reader.h>
   ...
   Class for reading datagram from dory's input socket that conforms to
   version 0 of the input message format.  Builds a TMsg from the datagram
   contents.
 */
...
namespace Dory {
  ...
  namespace InputDg {
    ...
    class TOldV0InputDgReader final {
      NO_COPY_SEMANTICS(TOldV0InputDgReader);
      ...
      /* Points to first byte of version-specific part of input datagram. */
