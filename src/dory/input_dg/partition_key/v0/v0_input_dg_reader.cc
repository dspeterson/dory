/* <dory/input_dg/partition_key/v0/v0_input_dg_reader.cc>
   ...
   Implements <dory/input_dg/partition_key/v0/v0_input_dg_reader.h>.
 */
...
using namespace Dory::InputDg::PartitionKey::V0;
