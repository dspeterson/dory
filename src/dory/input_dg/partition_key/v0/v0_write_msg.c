/* <dory/input_dg/partition_key/v0/v0_write_msg.cc>
   ...
   Implements <dory/input_dg/partition_key/v0/v0_write_msg.h>.
 */
...
#include <dory/input_dg/partition_key/v0/v0_input_dg_constants.h>
