/* <dory/input_dg/partition_key/v0/v0_input_dg_constants.h>
   ...
   Constants related to version 0 of PartitionKey input datagram format.
 */
...
enum { INPUT_DG_P_KEY_V0_TOPIC_SZ_FIELD_SIZE = 2 };
