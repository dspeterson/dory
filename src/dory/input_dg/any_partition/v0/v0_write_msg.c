/* <dory/input_dg/any_partition/v0/v0_write_msg.cc>
   ...
   Implements <dory/input_dg/any_partition/v0/v0_write_msg.h>.
 */
...
#include <dory/input_dg/any_partition/v0/v0_input_dg_constants.h>
...
int input_dg_any_p_v0_compute_msg_size(size_t *result, size_t topic_size,
  ...
  *result = 0;
  int ret = input_dg_any_p_v0_check_msg_size(topic_size, key_size, value_size);
...
void input_dg_any_p_v0_write_msg(void *result_buf, int64_t timestamp,
  ...
  if (input_dg_any_p_v0_compute_msg_size(&msg_size, topic_size, key_size,
        value_size) != DORY_OK) {
    assert(0);
    return;
  }
