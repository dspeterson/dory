/* ----------------------------------------------------------------------------
   ...
   ----------------------------------------------------------------------------
    ...
    This is a Java class for creating messages to be sent to Dory.
 */

package com.dspeterson.dory.dory_client_support;
...
public class DatagramCreator {
    ...
    /* Create an AnyPartition message with given topic, timestamp, key, and
       ...
       can then be sent to Dory's UNIX domain datagram socket. */
    ...
    /* Create a PartitionKey message with given partition key, topic,
       ...
       bytes.  The result can then be sent to Dory's UNIX domain datagram
       socket. */
