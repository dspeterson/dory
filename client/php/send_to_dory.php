...
/* ----------------------------------------------------------------------------
   ...
   ----------------------------------------------------------------------------
    ...
    This is an example PHP script that sends messages to Dory.
 */
...
/* According to the PHP documentation, the maximum value of an integer is
   ...
   64-bit systems, integers are 64 bits wide.  Dory's representation of
...
/* Class for creating datagrams to send to Dory. */
class DoryMsgCreator {
    ...
    /* Create and return an AnyPartition message that is ready to send to
       Dory.  $timestampHigh and $timestampLow should be values returned by
       methods getEpochMsHigh() and getEpochMsLow() of class
       DoryTimestampGenerator. */
...
$partitionKey = 12345;
$mc = new DoryMsgCreator;
$g = new DoryTimestampGenerator;
$g->setEpochTimeNow();
...
$tmp_filename = uniqid("/tmp/dory_client_", true);
